export const preloadHandlebarsTemplates = async function() {
    return loadTemplates([
        ...
        "systems/sbb/templates/sheets/partials/feat-stats.hbs",
        "systems/sbb/templates/sheets/partials/feat-health.hbs",
        "systems/sbb/templates/sheets/partials/feat-attacks.hbs",
    ]);
};